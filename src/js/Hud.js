...
//Stats info
    this.nameTxt = game.add.text(this.overBackground.width / 2, -this.overBackground.height -10,'Name: ');
    this.nameTxt.anchor.setTo(-0.06,2);
    this.nameTxt.fontSize = 19;
...
//Farm
    ...
    this.Red_Farm.income = this.stats.farmIncome;
    //Input logic
...
//Farm
    ...
    this.Yellow_Farm.income = this.stats.farmIncome;
    //Input logic
...
hud.prototype.listenerOver = function(Overed){  //Opens the unit stats display
        ...
        this.nameTxt.text = 'Name: ' + Overed.name;       
...
hud.prototype.listenerUnitSelection = function (clicked){   //DETERMINATES WHICH UNIT WAS SELECTED AND VERIFIES IF THERE IS ENOUGH MONEY TO BUY IT
...
hud.prototype.listenerStructureSelection = function (clicked){   //DETERMINATES WHICH STRUCTURE WAS SELECTED AND VERIFIES IF THERE IS ENOUGH MONEY TO BUY IT
...
hud.prototype.select = function(clicked){
    ...
    this.selected = true;
    this.selectedName = clicked.name;
    this.selectedPrice = clicked.price;
    this.selectedStrength = clicked.strength;
    this.selectedIncome = clicked.income;
    this.listenerClick();
}
